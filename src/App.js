...
function Relief(props) {
    ...
    const[highlightTuch,setHighlightTuch]= [props.highlightTuch, props.setHighlightTuch]
    const[highlightJesus,setHighlightJesus]= [props.highlightJesus, props.setHighlightJesus]
    const [infoText, setInfoText] = [props.infoText, props.setInfoText]
    const[canHighlight, setCanHighlight] = [props.canHighlight, props.setCanHighlight]
    ...
    else { currentMatTuch = materials.material0;}

    if (highlightJesus === true && canHighlight){
      currentMatJesus = materials.HoverJesus;
    }
    else { currentMatJesus = materials.material0;}
  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[2.4, -0.05, -0.05]}>
        ...
        onClick={(e) => {
            setInfoText("Das Schweisstuch, in das sich das Gesicht Jesu eingedrückt hat. Vera Ikon.");
        }}
        ...
        onClick={(e) => setInfoText("Dies ist Jesus. Er wurde vor 2000 Jahren geboren und wird von manchen als der Messiahs angesehen. War sicher ein cooler Dude.")}
...
function TextUI(props){
  ...
  const [questionCounter, setQuestionCounter] = [props.questionCounter, props.setQuestionCounter]
...
if (lernState === "Lernmodus")
{
  ...
  return(
    ...
    <Col className="button-column">
      <Button type="button" className='button1' onClick={(e) => setLernState("Quizmodus")}> Quizmodus </Button>
      <Button type="button" className='button1' onClick={(e) => setLernState("Anschaumodus")}> Anschaumodus </Button>
    </Col>
    </div>
    </div>
...
else if (lernState === "Quizmodus")
{
  ...
  <InputField fragen={fragen} setFragen={setFragen} questionCounter={questionCounter} setQuestionCounter={setQuestionCounter}/>
    <div>
    <Col className="button-column">
    <Button className='button1' type="button" onClick={(e) => {
      setHighlightJesus(false);
      setHighlightTuch(false);
      setInfoText("Klick auf einen hervorgehobenen Bereich um mehr zu lernen!")
...
else if (lernState === "Anschaumodus")
{
  ...
  return(
    ...
    <div>
    <Col className="button-column">
    <Button type="button" className='button1' onClick={(e) => {
      setHighlightJesus(false);
      setHighlightTuch(false);
      setInfoText("Klick auf einen hervorgehobenen Bereich um mehr zu lernen!")
      setLernState("Lernmodus");
...
function App()  {
    const[infoText,setInfoText]= useState("Klick auf einen hervorgehobenen Bereich um mehr zu lernen!")
    ...
    <div className="wrapper">
        <div className="card">
            ...
            <Canvas>
                    ...
                    <Relief infoText={infoText} setInfoText={setInfoText} canHighlight={canHighlight} setCanHighlight={setCanHighlight} highlightTuch={highlightTuch} setHighlightTuch={setHighlightTuch} highlightJesus={highlightJesus} setHighlightJesus={setHighlightJesus}/>
                    <OrbitControls enablePan={true} enableZoom={true} enableRotate={true}/>
            </Canvas>
            </Suspense>
            <TextUI questionCounter={questionCounter} setQuestionCounter={setQuestionCounter} fragen={fragen} setFragen={setFragen} infoText={infoText} setInfoText={setInfoText} lernState={lernState} setLernState={setLernState} canHighlight={canHighlight} setCanHighlight={setCanHighlight} highlightTuch={highlightTuch} setHighlightTuch={setHighlightTuch} highlightJesus={highlightJesus} setHighlightJesus={setHighlightJesus}/>
            </div>
        </div>
    </div>
</div>
